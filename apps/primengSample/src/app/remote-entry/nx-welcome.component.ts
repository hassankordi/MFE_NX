      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build primengSample
<span># Test</span>
nx test primengSample
<span># Lint</span>
nx lint primengSample
<span># Run them together!</span>
nx run-many -p primengSample -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project primengSample</pre>
          </details>
