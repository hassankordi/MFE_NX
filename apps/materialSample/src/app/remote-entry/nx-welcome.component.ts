      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build materialSample
<span># Test</span>
nx test materialSample
<span># Lint</span>
nx lint materialSample
<span># Run them together!</span>
nx run-many -p materialSample -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project materialSample</pre>
          </details>
